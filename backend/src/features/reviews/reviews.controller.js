...
const review_response_serializer_1 = require("./serializers/review-response.serializer");
let ReviewsController = class ReviewsController {
    ...
    create(dto, currentUser) {
        return this.reviewsService.create(dto, currentUser.userId).then(review_response_serializer_1.serializeReview);
    }
    findAll() {
        return this.reviewsService.findAll().then(review_response_serializer_1.serializeReviewList);
    }
    findOne(id) {
        return this.reviewsService.findOne(id).then(review_response_serializer_1.serializeReview);
    }
    update(id, dto, currentUser) {
        return this.reviewsService.update(id, dto, currentUser.userId).then(review_response_serializer_1.serializeReview);
    }
